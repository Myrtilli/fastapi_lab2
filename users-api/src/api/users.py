...
from src.models.users import User, UserIn, UserService, get_user_service
import logging
...
def update_user(user_id: UUID, updated_user: UserIn, service: UserService = Depends(get_user_service)):
